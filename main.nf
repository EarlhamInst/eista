...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    nf-core/eista
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    Github : https://github.com/nf-core/eista
    Website: https://nf-co.re/eista
    Slack  : https://nfcore.slack.com/channels/eista
----------------------------------------------------------------------------------------
*/
...
include { EISTA  } from './workflows/eista'
include { PIPELINE_INITIALISATION } from './subworkflows/local/utils_nfcore_eista_pipeline'
...
workflow {
    ...
    PIPELINE_COMPLETION (
        ...
        params.monochrome_logs,
        params.hook_url,
        NFCORE_EISTA.out.multiqc_report
    )
}
