...
workflow EISTA {
    ...
    if (params.run_analyses.contains('secondary')){
        ...
        // else if(params.skip_analyses.contains('clustering')){
        //     ch_h5ad = Channel.fromPath("${params.outdir}/clustering/adata_clustering.h5ad")
        // }else if(params.skip_analyses.contains('qccellfilter')){
        //     ch_h5ad = Channel.fromPath("${params.outdir}/qc_cell_filter/adata_filtered_normalized.h5ad")
        // }
        else{
            def path = "${params.outdir}/vizgen/mtx_conversions/combined_st_matrix.h5ad"
